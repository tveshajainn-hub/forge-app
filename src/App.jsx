// FORGE v5 — Fixed. Drop this into src/App.jsx
...
const INJURIES = [
  "Knee pain / injury","Lower back pain","Shoulder injury","Wrist pain",
  "Hip pain / injury","Ankle instability","Neck issues","No injuries",
];
...
const EX = {
  "Bodyweight Squat":       { bp:"Quads",     lvl:"Beginner",     eq:"None",           sets:3, reps:"15",          desc:"Feet shoulder-width apart, squat until thighs are parallel to the floor.",tip:"Keep chest tall, weight through the full foot." },
  "Goblet Squat":           { bp:"Quads",     lvl:"Beginner",     eq:"Dumbbell",       sets:3, reps:"12",           desc:"Hold dumbbell at chest. Excellent squat pattern developer.",tip:"Elbows brush inside of knees at the bottom." },
  "Barbell Back Squat":     { bp:"Quads",     lvl:"Advanced",     eq:"Barbell + Rack", sets:4, reps:"8–10",         desc:"The foundational lower body compound lift.",tip:"Brace your core like you're about to take a punch." },
  "Dumbbell Split Squat":   { bp:"Quads",     lvl:"Intermediate", eq:"Dumbbells",      sets:3, reps:"10–12 each",  desc:"Staggered stance, lower back knee toward floor.",tip:"Keep front shin vertical and torso upright." },
  "Bulgarian Split Squat":  { bp:"Quads",     lvl:"Advanced",     eq:"Bench + DBs",    sets:3, reps:"8–10 each",   desc:"Rear foot elevated on a bench. Most challenging single-leg variation.",tip:"Find balance before adding weight." },
  "Leg Press":              { bp:"Quads",     lvl:"Intermediate", eq:"Machine",        sets:3, reps:"12, 10, 8",   desc:"Push platform away, feet hip-width. Easy to progressively overload.",tip:"Don't lock out knees at the top." },
  "Reverse Lunge":          { bp:"Quads",     lvl:"Beginner",     eq:"Optional DBs",   sets:3, reps:"12 each",     desc:"Step backward and lower back knee. Easier on knees than forward lunges.",tip:"Front knee directly over ankle." },
  "Walking Lunge":          { bp:"Quads",     lvl:"Intermediate", eq:"Optional DBs",   sets:3, reps:"20 total",    desc:"Alternate forward lunges across the floor.",tip:"Long stride keeps tension on the quads." },
  "Glute Bridge":           { bp:"Glutes",    lvl:"Beginner",     eq:"Bodyweight",     sets:3, reps:"15",           desc:"Press through heels to lift hips. Activates glutes before heavier work.",tip:"Squeeze hard at the top — hold for a full second." },
  "Banded Glute Bridge":    { bp:"Glutes",    lvl:"Beginner",     eq:"Band",           sets:3, reps:"12",           desc:"Band above knees activates glute medius deeply.",tip:"Drive knees outward against the band throughout." },
  "Dumbbell Hip Thrust":    { bp:"Glutes",    lvl:"Intermediate", eq:"DB + Bench",     sets:3, reps:"12",           desc:"Upper back on bench, dumbbell on hips. Best home glute builder.",tip:"Upper back stays on bench — only hips move." },
  "Barbell Hip Thrust":     { bp:"Glutes",    lvl:"Intermediate", eq:"Barbell",        sets:4, reps:"10–12",        desc:"The definitive glute-building exercise.",tip:"Pad the barbell, chin tucked, full hip extension." },
  "Glute Kickback (Band)":  { bp:"Glutes",    lvl:"Beginner",     eq:"Band",           sets:3, reps:"12 each",     desc:"On all fours, kick leg back squeezing glute at top.",tip:"Add ankle weight for extra resistance." },
  "Sumo Squat":             { bp:"Glutes",    lvl:"Beginner",     eq:"Optional DB",    sets:3, reps:"15",           desc:"Wide stance, toes out. Targets glutes and inner thighs.",tip:"Hold dumbbell at chest for goblet variation." },
  "Resistance Band Deadlift":{ bp:"Hamstrings",lvl:"Beginner",    eq:"Band",           sets:3, reps:"15",           desc:"Band under feet, hinge at hips. Perfect hip hinge introduction.",tip:"Progress to single-leg after 2–3 weeks." },
  "Romanian Deadlift":      { bp:"Hamstrings",lvl:"Intermediate", eq:"Dumbbells",      sets:3, reps:"10–12",        desc:"Hinge at hips with slight knee bend. Feel the hamstring stretch.",tip:"Back stays flat — push hips backward, not down." },
  "Single-Leg RDL":         { bp:"Hamstrings",lvl:"Intermediate", eq:"Dumbbell",       sets:3, reps:"10 each",     desc:"Balance on one leg while hinging. Hamstring + stability.",tip:"Hips stay perfectly square to the floor." },
  "Lying Leg Curl":         { bp:"Hamstrings",lvl:"Intermediate", eq:"Machine",        sets:3, reps:"12, 10, 8",   desc:"Curl lower leg toward glutes. Pure hamstring isolation.",tip:"Control the lowering phase." },
  "Standing Calf Raise":    { bp:"Calves",    lvl:"Beginner",     eq:"Step (optional)", sets:4, reps:"20",          desc:"Rise onto toes and lower slowly through full range.",tip:"Full stretch at bottom matters as much as peak contraction." },
  "Single-Leg Calf Raise":  { bp:"Calves",    lvl:"Intermediate", eq:"Step + Wall",    sets:3, reps:"15 each",     desc:"One foot on step edge. Doubles the intensity.",tip:"Wall for balance support only." },
  "Knee Push-Up":           { bp:"Chest",     lvl:"Beginner",     eq:"Mat",            sets:3, reps:"12",           desc:"Knees on floor, straight line from knees to shoulders.",tip:"Women: hands slightly wider and more naturally angled." },
  "Full Push-Up":           { bp:"Chest",     lvl:"Intermediate", eq:"None",           sets:3, reps:"10–15",        desc:"Straight body from head to heels. Full chest activation.",tip:"Squeeze elbows slightly toward body." },
  "Chest Press (Machine)":  { bp:"Chest",     lvl:"Beginner",     eq:"Machine",        sets:3, reps:"12",           desc:"Machine bench press. Safe and effective for beginners.",tip:"Adjust seat so handles align with mid-chest." },
  "Dumbbell Chest Press":   { bp:"Chest",     lvl:"Intermediate", eq:"DBs + Bench",    sets:3, reps:"10–12",        desc:"Press dumbbells from chest to full extension.",tip:"Use the full range of motion — feel the stretch." },
  "Barbell Bench Press":    { bp:"Chest",     lvl:"Advanced",     eq:"Barbell + Bench", sets:4, reps:"8–10",        desc:"The classic compound chest exercise.",tip:"Retract shoulder blades, feet firmly on floor." },
  "Dumbbell Chest Fly":     { bp:"Chest",     lvl:"Intermediate", eq:"DBs + Bench",    sets:3, reps:"12–15",        desc:"Arc the dumbbells wide and back up. Pure chest isolation.",tip:"Maintain a slight permanent bend in the elbows." },
  "Resistance Band Row":    { bp:"Back",      lvl:"Beginner",     eq:"Band",           sets:3, reps:"12 each",     desc:"Stand on band, hinge forward and row to lower ribs.",tip:"Drive elbow past your hip." },
  "Dumbbell Bent-Over Row": { bp:"Back",      lvl:"Intermediate", eq:"DB + Bench",     sets:3, reps:"10–12 each",  desc:"One hand on bench, row dumbbell from floor to hip.",tip:"Elbow drives straight back." },
  "Lat Pulldown":           { bp:"Back",      lvl:"Intermediate", eq:"Cable Machine",  sets:3, reps:"10–12",        desc:"Pull bar to upper chest. Elbows drive down and back.",tip:"Lean back slightly, keep chest tall." },
  "Seated Cable Row":       { bp:"Back",      lvl:"Intermediate", eq:"Cable Machine",  sets:3, reps:"10–12",        desc:"Seated row to lower ribs. Squeeze shoulder blades at end.",tip:"Don't rock torso." },
  "Pull-Up":                { bp:"Back",      lvl:"Advanced",     eq:"Pull-up Bar",    sets:3, reps:"5–8",          desc:"Drive elbows down to pull chin above bar.",tip:"Start with negatives." },
  "Face Pull":              { bp:"Back",      lvl:"Intermediate", eq:"Cable or Band",  sets:3, reps:"15–20",        desc:"Pull toward face with external rotation. Shoulder health essential.",tip:"Hands finish beside your ears." },
  "Band Pull-Apart":        { bp:"Shoulders", lvl:"Beginner",     eq:"Band",           sets:3, reps:"20",           desc:"Pull band apart squeezing shoulder blades. Excellent warm-up.",tip:"Do this before every upper body session." },
  "Dumbbell Lateral Raise": { bp:"Shoulders", lvl:"Beginner",     eq:"Dumbbells",      sets:3, reps:"15",           desc:"Raise to shoulder height. Targets medial deltoid for width.",tip:"Lead with elbows — imagine pouring water from a jug." },
  "Dumbbell Front Raise":   { bp:"Shoulders", lvl:"Beginner",     eq:"Dumbbells",      sets:2, reps:"12",           desc:"Raise both arms forward to eye level.",tip:"Keep core braced to avoid swinging." },
  "Dumbbell Shoulder Press":{ bp:"Shoulders", lvl:"Intermediate", eq:"Dumbbells",      sets:3, reps:"10–12",        desc:"Press from ear height to overhead. Full deltoid activation.",tip:"Don't arch lower back — keep ribs down." },
  "Arnold Press":           { bp:"Shoulders", lvl:"Intermediate", eq:"Dumbbells",      sets:3, reps:"10–12",        desc:"Rotate palms inward to outward as you press.",tip:"Hits all three deltoid heads in one movement." },
  "Dumbbell Bicep Curl":    { bp:"Biceps",    lvl:"Beginner",     eq:"Dumbbells",      sets:3, reps:"12",           desc:"Classic curl. Supinate wrist as you curl up.",tip:"Keep elbows pinned to your sides." },
  "Hammer Curl":            { bp:"Biceps",    lvl:"Beginner",     eq:"Dumbbells",      sets:3, reps:"12",           desc:"Neutral grip throughout. Targets brachialis for arm thickness.",tip:"Great for overall arm thickness." },
  "Barbell Curl":           { bp:"Biceps",    lvl:"Intermediate", eq:"Barbell",        sets:3, reps:"10–12",        desc:"Classic barbell curl. Allows heavier loading.",tip:"Keep wrists straight throughout." },
  "Chair Dip":              { bp:"Triceps",   lvl:"Beginner",     eq:"Chair",          sets:3, reps:"12",           desc:"Hands on chair, lower and press. Pure bodyweight tricep builder.",tip:"Further feet = harder." },
  "Band Tricep Pushdown":   { bp:"Triceps",   lvl:"Beginner",     eq:"Band",           sets:3, reps:"15",           desc:"Push down extending elbow to full lockout.",tip:"Keep elbows pinned tight to sides." },
  "Overhead Tricep Ext":    { bp:"Triceps",   lvl:"Intermediate", eq:"DB or Band",     sets:3, reps:"12",           desc:"Weight overhead, bend elbows to lower behind head.",tip:"Only position that fully stretches the long head." },
  "Plank":                  { bp:"Core",      lvl:"Beginner",     eq:"Mat",            sets:3, reps:"30–45 sec",   desc:"Squeeze abs, glutes, and quads simultaneously.",tip:"Perfect straight line — no sagging or piking." },
  "Dead Bug":               { bp:"Core",      lvl:"Beginner",     eq:"Mat",            sets:3, reps:"10 each",     desc:"Extend opposite arm and leg. Anti-extension stability.",tip:"Press lower back into floor the entire time." },
  "Bicycle Crunch":         { bp:"Core",      lvl:"Intermediate", eq:"Mat",            sets:3, reps:"20 total",    desc:"Alternating elbow-to-knee. Full oblique engagement.",tip:"Slow and controlled — quality over speed." },
  "Leg Raise":              { bp:"Core",      lvl:"Intermediate", eq:"Mat",            sets:3, reps:"12",           desc:"Raise straight legs to 90 degrees. Lower ab challenge.",tip:"Press lower back down as legs lower." },
  "Side Plank":             { bp:"Core",      lvl:"Intermediate", eq:"Mat",            sets:2, reps:"30 sec each", desc:"Support on one forearm. Lateral core stability.",tip:"Hip stays high throughout." },
  "Brisk Walk":             { bp:"Cardio",    lvl:"Beginner",     eq:"None",           sets:1, reps:"30–45 min",  desc:"Elevated heart rate but still conversational. Zone 2 training.",tip:"Arms pumping actively." },
  "Stationary Cycling":     { bp:"Cardio",    lvl:"Beginner",     eq:"Stationary Bike", sets:1, reps:"20–45 min", desc:"Low-impact cardio you can do while watching TV.",tip:"Zone 2: you can talk but are slightly breathless." },
  "Swimming Laps":          { bp:"Cardio",    lvl:"Beginner",     eq:"Pool",           sets:1, reps:"30–45 min",  desc:"Full-body low-impact cardio. Great active recovery.",tip:"Mix strokes for a complete full-body session." },
  "Pilates Flow":           { bp:"Cardio",    lvl:"Beginner",     eq:"Mat",            sets:1, reps:"45–60 min",  desc:"Core-focused movement building strength and flexibility.",tip:"Breath drives the movement in Pilates." },
  "Jump Rope":              { bp:"Cardio",    lvl:"Intermediate", eq:"Jump Rope",      sets:1, reps:"10 min",     desc:"High-intensity cardio. Burns significant calories quickly.",tip:"Land softly on balls of feet." },
  "Dance Fitness":          { bp:"Cardio",    lvl:"Intermediate", eq:"None",           sets:1, reps:"20–40 min",  desc:"High-energy dance cardio at maximum heart rate.",tip:"You should NOT be able to hold a conversation." },
  "Box Steps":              { bp:"Cardio",    lvl:"Intermediate", eq:"Step or Chair",  sets:2, reps:"20 each leg", desc:"Step up on a surface. Combines lower body strength with cardio.",tip:"Lead with alternate legs each set." },
  "Shuttle Runs":           { bp:"Cardio",    lvl:"Advanced",     eq:"Open Space",     sets:1, reps:"6,5,4,3,2,1", desc:"Sprint end-to-end in descending rounds. Maximum effort.",tip:"Maximum effort on every single sprint." },
};

const GENDER_NOTES = {
  Female: { levelNote:"For women, research shows glute and lower body training with hip-dominant movements delivers the strongest results early on. Your plan is weighted toward this.", priorityBP:["Glutes","Quads","Hamstrings","Core"] },
  Male:   { levelNote:"For men, compound push/pull movements with progressive overload drive the fastest strength gains. Your plan prioritises upper-lower balance.", priorityBP:["Chest","Back","Shoulders","Quads"] },
  "Prefer not to say": { levelNote:"Your plan is built for balanced full-body development.", priorityBP:["Quads","Glutes","Chest","Back"] },
};
...
function filterExercisesForInjuries(exList,injuries){if(!injuries||injuries.includes("No injuries"))return exList;const excluded=new Set(injuries.flatMap(inj=>INJURY_EXCLUDE[inj]||[]));return exList.filter(ex=>!excluded.has(ex.n));}
function applyInjuriesToPlan(plan,injuries){if(!injuries||injuries.includes("No injuries"))return plan;const newPlan={};Object.entries(plan).forEach(([d,day])=>{newPlan[d]={...day,exs:(day.exs||[]).filter(ex=>!injuries.flatMap(inj=>INJURY_EXCLUDE[inj]||[]).includes(ex.n))};});return newPlan;}

let _sb=null;
function getSB(){if(_sb)return _sb;if(SUPABASE_URL==="YOUR_SUPABASE_URL_HERE")return null;try{_sb=createClient(SUPABASE_URL,SUPABASE_KEY);return _sb;}catch{return null;}}
...
function useStorage(userId){
  ...
  useEffect(()=>{
    ...
    (async()=>{
      ...
      const sb=getSB();
      if(sb&&userId){try{const{data:rows}=await sb.from("forge_data").select("key,value").eq("user_id",userId);(rows||[]).forEach(r=>{try{const v=JSON.parse(r.value);if(r.key==="profile")d.profile=v;else if(r.key==="strength")d.strength=v;else if(r.key==="weight")d.weightLog=v;else if(r.key==="achievements")d.earnedAchievements=v;else if(r.key==="targets")d.targets=v;else if(r.key.startsWith("log_"))d.logs[r.key.slice(4)]=v;}catch{}});}catch{}}
      else{try{const s=localStorage.getItem("forge_local");if(s)Object.assign(d,JSON.parse(s));}catch{}}
      setData(d);setReady(true);
    })();
  },[userId]);
  const flush=useCallback(()=>{const p={...q.current};q.current={};const sb=getSB();Object.entries(p).forEach(async([k,v])=>{if(sb&&userId){try{await sb.from("forge_data").upsert({user_id:userId,key:k,value:JSON.stringify(v),updated_at:new Date().toISOString()});}catch{}}else{try{const s=JSON.parse(localStorage.getItem("forge_local")||"{}");s[k]=v;localStorage.setItem("forge_local",JSON.stringify(s));}catch{}}});},[userId]);
...
function useAuth(){
  ...
  useEffect(()=>{if(!sb){setAuthLoading(false);return;}sb.auth.getSession().then(({data})=>{setUser(data?.session?.user||null);setAuthLoading(false);});const{data:{subscription}}=sb.auth.onAuthStateChange((_,session)=>{setUser(session?.user||null);});return()=>subscription?.unsubscribe();},[]);
...
function YTThumb({name,bp,height=100}){
  const color=BP[bp]?.color||C.accent;
  const searchUrl=`https://www.youtube.com/results?search_query=${encodeURIComponent("how to do "+(name||"")+" exercise proper form")}`;
  return(<div onClick={()=>window.open(searchUrl,"_blank")} style={{height,borderRadius:12,background:`linear-gradient(135deg,${color}18,${color}08)`,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",border:`1.5px solid ${color}30`,cursor:"pointer",gap:8,transition:"all .2s"}}><div style={{width:44,height:44,background:"#FF0000CC",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{color:"#fff",fontSize:16,marginLeft:3}}>▶</span></div><div style={{fontSize:11,color,fontWeight:700,textAlign:"center",padding:"0 12px",lineHeight:1.4}}>Watch on YouTube<br/><span style={{fontSize:10,color:C.muted,fontWeight:400}}>Best tutorial auto-selected</span></div></div>);
}
...
function ShareModal({data,streak,onClose}){
  ...
  const share=async()=>{try{if(navigator.share)await navigator.share({title:"My FORGE Progress",text:txt,url:"https://forgebetteryou.netlify.app"});}catch{}};
  const copy=async()=>{try{await navigator.clipboard.writeText(txt);setCopied(true);setTimeout(()=>setCopied(false),2000);}catch{}};
...
function PlanEditor({profile,preset,injuries,onSave,onClose,title="Edit Your Plan"}){
  ...
  const [plan,setPlan]=useState(()=>{const p={};[0,1,2,3,4,5,6].forEach(d=>{p[d]={...(currentPlan[d]||preset.days[0]),exs:[...(currentPlan[d]?.exs||[])]};});return p;});
  ...
  const assignPresetDay=(calDay,presetDayKey)=>{const template=presetDayKey==="rest"?restDay:{...preset.days[presetDayKey],exs:filterExercisesForInjuries([...(preset.days[presetDayKey].exs||[])],injuries)};setPlan(p=>({...p,[calDay]:template}));};
  const swapExercise=(calDay,exIdx,newExName)=>{const info=EX[newExName]||{};setPlan(p=>{const exs=[...p[calDay].exs];exs[exIdx]={n:newExName,s:info.sets||3,r:info.reps||"12",bp:info.bp};return{...p,[calDay]:{...p[calDay],exs}};});setSwapExIdx(null);setExSearchBP(null);};
  const removeExercise=(calDay,exIdx)=>setPlan(p=>{const exs=[...p[calDay].exs];exs.splice(exIdx,1);return{...p,[calDay]:{...p[calDay],exs}};});
  const addExercise=(calDay,exName)=>{const info=EX[exName]||{};const ex={n:exName,s:info.sets||3,r:info.reps||"12",bp:info.bp};setPlan(p=>({...p,[calDay]:{...p[calDay],exs:[...(p[calDay].exs||[]),ex]}}));};
  const availableExForSwap=useMemo(()=>{if(editDay===null||swapExIdx===null)return[];const bp=exSearchBP||(plan[editDay]?.exs[swapExIdx]?.bp);const excluded=injuries?.flatMap(inj=>INJURY_EXCLUDE[inj]||[])||[];return Object.entries(EX).filter(([n,i])=>{if(excluded.includes(n))return false;if(bp&&i.bp!==bp)return false;return true;});},[editDay,swapExIdx,exSearchBP,injuries,plan]);
  return(
    <div style={{position:"fixed",inset:0,background:C.bg,zIndex:200,overflowY:"auto"}}>
      <div style={{maxWidth:430,margin:"0 auto",padding:"20px 20px 100px"}}>
        ...
        {editDay===null&&<>
          <div style={{background:"#FF450012",border:`1px solid #FF450030`,borderRadius:12,padding:"10px 14px",marginBottom:16,fontSize:13,color:"#FF8C42",lineHeight:1.6}}>💡 Tap any day to change it or swap exercises. Your logged workout data stays safe.</div>
          {[0,1,2,3,4,5,6].map(d=>{const day=plan[d];const isRest=day?.type==="rest";return(<div key={d} onClick={()=>setEditDay(d)} style={{background:C.card,border:`1.5px solid ${C.border}`,borderRadius:14,marginBottom:8,padding:"14px",cursor:"pointer",display:"flex",alignItems:"center",gap:12,transition:"all .2s"}}><div style={{width:40,height:40,borderRadius:12,background:isRest?"#1C2440":day?.color+"22",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,flexShrink:0}}>{day?.emoji||"😴"}</div><div style={{flex:1}}><div style={{fontWeight:700,fontSize:14,color:C.text}}>{FULL_DAYS[d]}</div><div style={{fontSize:12,color:C.muted,marginTop:2}}>{day?.focus||"Rest"}{!isRest&&day?.exs?.length>0?` · ${day.exs.length} exercises`:""}</div></div><span style={{color:C.muted,fontSize:18}}>›</span></div>);})}
        ...
        {editDay!==null&&swapExIdx===null&&(()=>{
          ...
          return(<>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16}}><button onClick={()=>setEditDay(null)} style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:10,padding:"8px 14px",color:C.subtle,cursor:"pointer",fontFamily:"DM Sans,sans-serif",fontWeight:600,fontSize:13}}>← Days</button><div className="sora" style={{fontSize:16,fontWeight:800}}>{FULL_DAYS[editDay]}</div></div>
            ...
            <div style={{display:"flex",gap:6,overflowX:"auto",marginBottom:16,padding:"0 0 6px",scrollbarWidth:"none"}}>
              <div onClick={()=>assignPresetDay(editDay,"rest")} style={{flexShrink:0,padding:"8px 14px",borderRadius:30,border:`1.5px solid ${isRest?"#4A5580":C.border}`,background:isRest?"#4A558022":"transparent",cursor:"pointer",display:"flex",gap:6,alignItems:"center"}}><span style={{fontSize:14}}>😴</span><span style={{fontSize:12,color:isRest?"#8B93C4":C.muted,fontWeight:isRest?700:400,whiteSpace:"nowrap"}}>Rest Day</span></div>
              {Object.entries(preset.days).filter(([,p])=>p.type!=="rest").map(([key,p])=>(<div key={key} onClick={()=>assignPresetDay(editDay,key)} style={{flexShrink:0,padding:"8px 14px",borderRadius:30,border:`1.5px solid ${day?.focus===p.focus?p.color:C.border}`,background:day?.focus===p.focus?p.color+"22":"transparent",cursor:"pointer",display:"flex",gap:6,alignItems:"center"}}><span style={{fontSize:14}}>{p.emoji}</span><span style={{fontSize:12,color:day?.focus===p.focus?p.color:C.muted,fontWeight:day?.focus===p.focus?700:400,whiteSpace:"nowrap"}}>{p.focus}</span></div>))}
            </div>
            {!isRest&&<>
              ...
              {(day.exs||[]).map((ex,i)=>{const bpc=BP[ex.bp]?.color||C.accent;return(<div key={i} style={{background:C.card,border:`1.5px solid ${C.border}`,borderRadius:12,marginBottom:7,padding:"11px 13px",display:"flex",alignItems:"center",gap:10}}><span style={{fontSize:18}}>{BP[ex.bp]?.icon||"💪"}</span><div style={{flex:1}}><div style={{fontWeight:600,fontSize:13,color:C.text}}>{ex.n}</div><div style={{fontSize:11,color:C.muted,marginTop:2}}>{ex.s} sets × {ex.r}</div></div><Pill label={ex.bp} color={bpc}/><button onClick={()=>setSwapExIdx(i)} style={{background:"#6366F120",border:`1px solid #6366F140`,borderRadius:8,padding:"5px 10px",color:"#818CF8",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"DM Sans,sans-serif",flexShrink:0}}>Swap</button><button onClick={()=>removeExercise(editDay,i)} style={{background:"transparent",border:"none",color:C.muted,cursor:"pointer",fontSize:16,flexShrink:0,padding:"2px 4px"}}>✕</button></div>);})}
              ...
              <div style={{display:"flex",gap:5,overflowX:"auto",marginBottom:10,scrollbarWidth:"none"}}>{Object.keys(BP).map(bp=><Chip key={bp} label={bp} color={BP[bp]?.color} active={exSearchBP===bp} onClick={()=>setExSearchBP(exSearchBP===bp?null:bp)} small/>)}</div>
              {exSearchBP&&Object.entries(EX).filter(([n,i])=>i.bp===exSearchBP&&!(injuries?.flatMap(inj=>INJURY_EXCLUDE[inj]||[])||[]).includes(n)&&!(day.exs||[]).some(e=>e.n===n)).slice(0,6).map(([name,info])=>(<div key={name} onClick={()=>{addExercise(editDay,name);setExSearchBP(null);}} style={{background:C.card,border:`1.5px solid ${C.border}`,borderRadius:10,padding:"9px 12px",marginBottom:6,cursor:"pointer",display:"flex",gap:8,alignItems:"center"}}><span style={{fontSize:16}}>{BP[info.bp]?.icon}</span><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600}}>{name}</div><div style={{fontSize:11,color:C.muted}}>{info.lvl} · {info.reps}</div></div><span style={{color:"#34D399",fontWeight:700}}>+</span></div>))}
            </>}
          </>);
        })()}
        {editDay!==null&&swapExIdx!==null&&(()=>{
          ...
          return(<>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}><button onClick={()=>setSwapExIdx(null)} style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:10,padding:"8px 14px",color:C.subtle,cursor:"pointer",fontFamily:"DM Sans,sans-serif",fontWeight:600,fontSize:13}}>← Back</button><div className="sora" style={{fontSize:16,fontWeight:800}}>Swap: {currentEx?.n}</div></div>
            ...
            <div style={{display:"flex",gap:5,overflowX:"auto",marginBottom:12,scrollbarWidth:"none"}}><Chip label="Same muscle" color={BP[currentEx?.bp]?.color||C.accent} active={!exSearchBP} onClick={()=>setExSearchBP(null)} small/>{Object.keys(BP).map(bp=><Chip key={bp} label={bp} color={BP[bp]?.color} active={exSearchBP===bp} onClick={()=>setExSearchBP(bp)} small/>)}</div>
            {availableExForSwap.map(([name,info])=>(<div key={name} onClick={()=>swapExercise(editDay,swapExIdx,name)} style={{background:C.card,border:`1.5px solid ${name===currentEx?.n?"#6366F1":C.border}`,borderRadius:12,marginBottom:7,padding:"12px 13px",cursor:"pointer",display:"flex",gap:10,alignItems:"center"}}><span style={{fontSize:18}}>{BP[info.bp]?.icon}</span><div style={{flex:1}}><div style={{fontWeight:600,fontSize:13,color:name===currentEx?.n?"#818CF8":C.text}}>{name}</div><div style={{fontSize:11,color:C.muted,marginTop:2}}>{info.lvl} · {info.eq} · {info.reps}</div></div>{name===currentEx?.n&&<span style={{color:"#818CF8",fontWeight:800,flexShrink:0}}>Current</span>}</div>))}
          </>);
        })()}
      </div>
    </div>
...
function UpgradePlanModal({currentLevel,profile,setProfile,onClose}){
  const currentIdx=LEVEL_ORDER.indexOf(currentLevel);const nextLevel=LEVEL_ORDER[currentIdx+1];const [confirmed,setConfirmed]=useState(false);
  if(!nextLevel)return(<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.85)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",padding:20}} onClick={onClose}><div style={{background:C.card,borderRadius:20,padding:28,maxWidth:360,textAlign:"center"}} onClick={e=>e.stopPropagation()}><div style={{fontSize:48,marginBottom:12}}>👑</div><div className="sora" style={{fontSize:22,fontWeight:900,marginBottom:8}}>You're already at the top!</div><p style={{color:C.subtle,fontSize:14,lineHeight:1.7,marginBottom:20}}>Advanced is the highest level. Keep pushing.</p><Btn onClick={onClose} style={{width:"100%"}}>Got it!</Btn></div></div>);
  const next=PRESET_PLANS[nextLevel];
  return(<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.85)",zIndex:300,display:"flex",alignItems:"flex-end",justifyContent:"center"}} onClick={onClose}><div style={{background:C.card,borderRadius:"20px 20px 0 0",padding:24,width:"100%",maxWidth:430,paddingBottom:40,maxHeight:"85vh",overflowY:"auto"}} onClick={e=>e.stopPropagation()}><div style={{width:40,height:4,background:C.border,borderRadius:4,margin:"0 auto 20px"}}/><div className="sora" style={{fontSize:20,fontWeight:800,marginBottom:4}}>⬆️ Upgrade to {nextLevel}</div><p style={{color:C.subtle,fontSize:13,marginBottom:16,lineHeight:1.6}}>{next.rationale}</p><div style={{background:"#FF450012",border:`1px solid #FF450030`,borderRadius:12,padding:"12px 14px",marginBottom:16,fontSize:13,color:"#FF8C42",lineHeight:1.6}}>⚠️ This replaces your current plan. Your workout logs and strength data are always kept.</div>{Object.entries(next.days).map(([d,day])=>(<div key={d} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 0",borderBottom:`1px solid ${C.border}`}}><div style={{width:32,height:32,borderRadius:10,background:day.color+"22",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,flexShrink:0}}>{day.emoji}</div><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600}}>{FULL_DAYS[d]}</div><div style={{fontSize:11,color:C.muted}}>{day.focus}</div></div><Pill label={day.tag||"REST"} color={day.color}/></div>))}<div style={{display:"flex",gap:8,marginTop:16}}><Btn onClick={onClose} secondary style={{flex:1,padding:"12px"}}>Not yet</Btn><Btn onClick={()=>{setProfile({...profile,level:nextLevel,plan:PRESET_PLANS[nextLevel].days});setConfirmed(true);setTimeout(onClose,1500);}} style={{flex:2,padding:"12px",background:`linear-gradient(135deg,${C.accent},#FF8C42)`}}>{confirmed?"✓ Upgraded!":"Upgrade my plan"}</Btn></div></div></div>);
}

function LoginScreen({signInGoogle,hasSB,onSkip}){
  const [loading,setLoading]=useState(false);
  return(<div style={{minHeight:"100vh",background:C.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"32px 24px",maxWidth:400,margin:"0 auto"}}><div style={{textAlign:"center",marginBottom:40}}><div style={{fontSize:56,marginBottom:16,animation:"glow 2s ease-in-out infinite"}}>🔥</div><div className="sora" style={{fontSize:36,fontWeight:900,letterSpacing:-1,marginBottom:8}}>FORGE<span style={{color:C.accent}}>.</span></div><div style={{fontSize:15,color:C.subtle,lineHeight:1.7}}>Your personal training app.<br/>Log in to sync across all your devices.</div></div>{hasSB?(<><button onClick={async()=>{setLoading(true);await signInGoogle();setLoading(false);}} disabled={loading} style={{width:"100%",padding:"16px 20px",borderRadius:16,border:"2px solid #2A3560",background:"#0F1830",cursor:loading?"not-allowed":"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:14,marginBottom:14,transition:"all .2s",opacity:loading?.6:1}}><svg width="22" height="22" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg><span style={{fontWeight:700,fontSize:16,color:C.text,fontFamily:"DM Sans,sans-serif"}}>{loading?"Connecting…":"Continue with Google"}</span></button><div style={{fontSize:12,color:C.muted,textAlign:"center",lineHeight:1.7,marginBottom:20}}>Your data is private. No password needed.</div><button onClick={onSkip} style={{background:"transparent",border:"none",color:C.muted,fontSize:13,cursor:"pointer",textDecoration:"underline",fontFamily:"DM Sans,sans-serif"}}>Continue without login (data won't sync between devices)</button></>):(<><div style={{background:"#FF450015",border:"1px solid #FF450040",borderRadius:14,padding:16,marginBottom:20,fontSize:13,color:"#FF8C42",lineHeight:1.7,textAlign:"center"}}><strong>Add Supabase credentials</strong> to the top of App.jsx to enable Google login.</div><Btn onClick={onSkip} style={{width:"100%",background:`linear-gradient(135deg,${C.accent},#FF8C42)`}}>Continue without login →</Btn></>)}</div>);
}

function Onboarding({onDone,userName}){
  const [step,setStep]=useState(0);const [name,setName]=useState(userName||"");const [gender,setGender]=useState(null);const [age,setAge]=useState("");const [level,setLevel]=useState(null);const [goals,setGoals]=useState([]);const [equipment,setEquipment]=useState(null);const [injuries,setInjuries]=useState([]);const [showPlanEditor,setShowPlanEditor]=useState(false);const [customPlan,setCustomPlan]=useState(null);
  const toggleInjury=i=>setInjuries(p=>p.includes(i)?p.filter(x=>x!==i):[...p.filter(x=>x!=="No injuries"),i]);
  const ageNum=parseInt(age)||25;const preset=level?PRESET_PLANS[level]:PRESET_PLANS.Beginner;
  const buildFinalPlan=()=>{if(customPlan)return customPlan;return applyInjuriesToPlan(preset.days,injuries);};
  ...
  if(showPlanEditor)return(<PlanEditor profile={{plan:customPlan||preset.days,level}} preset={preset} injuries={injuries} title="Customise Your Plan" onSave={p=>{setCustomPlan(p);setShowPlanEditor(false);}} onClose={()=>setShowPlanEditor(false)}/>);
  const STEPS=[
    <div key="s0" className="fade-up" style={{display:"flex",flexDirection:"column",gap:22}}>
      <div><div className="sora" style={{fontSize:11,color:C.accent,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>Welcome to FORGE</div><div className="sora" style={{fontSize:28,fontWeight:900,lineHeight:1.1}}>Let's build your plan<span style={{color:C.accent}}>.</span></div><p style={{color:C.subtle,marginTop:8,fontSize:14,lineHeight:1.7}}>A few quick questions so we can personalise everything — including working around any injuries.</p></div>
      <Inp label="Your name" value={name} onChange={setName} placeholder="e.g. Tvesha"/>
      <div><div style={{fontSize:11,color:C.muted,fontWeight:600,letterSpacing:.5,textTransform:"uppercase",marginBottom:10}}>I identify as</div><div style={{display:"flex",gap:8}}>{["Female","Male","Prefer not to say"].map(g=>(<div key={g} onClick={()=>setGender(g)} style={{flex:1,padding:"12px 8px",borderRadius:12,border:`2px solid ${gender===g?"#6366F1":C.border}`,background:gender===g?"#6366F115":C.card,cursor:"pointer",textAlign:"center",fontSize:13,fontWeight:gender===g?700:400,color:gender===g?"#818CF8":C.muted,transition:"all .2s"}}>{g==="Female"?"👩":g==="Male"?"👨":"🙋"}<div style={{marginTop:4,fontSize:11}}>{g}</div></div>))}</div>{gender&&gender!=="Prefer not to say"&&<div style={{marginTop:10,padding:"10px 12px",background:"#6366F110",borderRadius:10,fontSize:12,color:"#818CF8",lineHeight:1.6}}>💡 {GENDER_NOTES[gender].levelNote}</div>}</div>
      ...
      {ageNum<18&&age&&<div style={{background:"#FBBF2410",border:`1px solid #FBBF2430`,borderRadius:10,padding:"10px 12px",fontSize:12,color:"#FBBF24",lineHeight:1.6}}>⚡ For under 18s, we focus on form and bodyweight first.</div>}
    ...
    <div key="s1" className="fade-up" style={{display:"flex",flexDirection:"column",gap:22}}>
      ...
      {LEVELS.map(({k,icon,desc,color})=>(<div key={k} onClick={()=>setLevel(k)} style={{padding:"16px",borderRadius:14,border:`2px solid ${level===k?color:C.border}`,background:level===k?color+"12":C.card,cursor:"pointer",display:"flex",gap:14,alignItems:"center",transition:"all .2s"}}><span style={{fontSize:28}}>{icon}</span><div style={{flex:1}}><div style={{fontWeight:700,fontSize:16,color:level===k?color:C.text}}>{k}</div><div style={{fontSize:12,color:C.muted,marginTop:2}}>{desc}</div>{level===k&&<div style={{fontSize:12,color,marginTop:6,lineHeight:1.5}}>{PRESET_PLANS[k].label}</div>}</div>{level===k&&<div style={{width:24,height:24,borderRadius:"50%",background:color,display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",fontSize:12,fontWeight:800,flexShrink:0}}>✓</div>}</div>))}
      <div style={{display:"flex",gap:10}}><Btn onClick={()=>setStep(0)} secondary style={{flex:1}}>← Back</Btn><Btn onClick={()=>setStep(2)} disabled={!level} style={{flex:2}}>Continue →</Btn></div>
    </div>,
    <div key="s2" className="fade-up" style={{display:"flex",flexDirection:"column",gap:20}}>
      ...
      <div><div style={{fontSize:11,color:C.muted,fontWeight:600,letterSpacing:.5,textTransform:"uppercase",marginBottom:10}}>Your goals</div><div style={{display:"flex",flexWrap:"wrap",gap:8}}>{ALL_GOALS.map(g=><Chip key={g} label={g} color={C.accent} active={goals.includes(g)} onClick={()=>setGoals(p=>p.includes(g)?p.filter(x=>x!==g):[...p,g])}/>)}</div></div>
      <div><div style={{fontSize:11,color:C.muted,fontWeight:600,letterSpacing:.5,textTransform:"uppercase",marginBottom:10}}>Equipment access</div>{ALL_EQ.map(e=><div key={e} onClick={()=>setEquipment(e)} style={{padding:"12px 16px",borderRadius:12,border:`2px solid ${equipment===e?"#6366F1":C.border}`,background:equipment===e?"#6366F112":C.card,cursor:"pointer",fontSize:14,marginBottom:8,color:equipment===e?"#818CF8":C.subtle,fontWeight:equipment===e?700:400,transition:"all .2s"}}>{e}</div>)}</div>
      <div><div style={{fontSize:11,color:C.muted,fontWeight:600,letterSpacing:.5,textTransform:"uppercase",marginBottom:8}}>Any injuries or pain areas?</div><div style={{display:"flex",flexWrap:"wrap",gap:7}}>{INJURIES.map(inj=>(<div key={inj} onClick={()=>{if(inj==="No injuries")setInjuries(["No injuries"]);else toggleInjury(inj);}} style={{padding:"7px 14px",borderRadius:30,border:`1.5px solid ${injuries.includes(inj)?inj==="No injuries"?"#34D399":"#F87171":C.border}`,background:injuries.includes(inj)?inj==="No injuries"?"#34D39920":"#F8717120":"transparent",cursor:"pointer",fontSize:13,fontWeight:injuries.includes(inj)?700:400,color:injuries.includes(inj)?inj==="No injuries"?"#34D399":"#F87171":C.muted,transition:"all .2s"}}>{inj==="No injuries"?"✓ ":injuries.includes(inj)&&inj!=="No injuries"?"⚠️ ":""}{inj}</div>))}</div>{injuries.length>0&&!injuries.includes("No injuries")&&<div style={{marginTop:10,padding:"10px 12px",background:"#F8717110",borderRadius:10,fontSize:12,color:"#F87171",lineHeight:1.6}}>⚠️ We'll remove exercises that aggravate: {injuries.join(", ")}.</div>}</div>
      <div style={{display:"flex",gap:10}}><Btn onClick={()=>setStep(1)} secondary style={{flex:1}}>← Back</Btn><Btn onClick={()=>setStep(3)} disabled={!goals.length||!equipment||!injuries.length} style={{flex:2}}>Review plan →</Btn></div>
    </div>,
    <div key="s3" className="fade-up" style={{display:"flex",flexDirection:"column",gap:18}}>
      <div><div className="sora" style={{fontSize:26,fontWeight:800}}>Your plan is ready 🎉</div><p style={{color:C.subtle,marginTop:6,fontSize:14}}>Built for {level} · {gender} · {ageNum} yrs. Tap "Edit" to customise any day or swap exercises.</p></div>
      <div style={{padding:"12px 14px",background:"#FF450010",border:`1px solid ${C.accent}30`,borderRadius:12}}><div style={{fontSize:11,color:C.accent,fontWeight:700,marginBottom:4}}>WHY THIS PLAN</div><div style={{fontSize:12,color:C.subtle,lineHeight:1.6}}>{preset.rationale}</div></div>
      <Card>{[0,1,2,3,4,5,6].map((d,i)=>{const plan=customPlan||applyInjuriesToPlan(preset.days,injuries);const day=plan[d];const isRest=day?.type==="rest";return(<div key={d} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:i<6?`1px solid ${C.border}`:"none"}}><div style={{width:34,height:34,borderRadius:10,background:isRest?"#1C2440":day?.color+"22",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>{day?.emoji||"😴"}</div><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600,color:isRest?C.muted:C.text}}>{FULL_DAYS[d]}</div><div style={{fontSize:11,color:C.muted}}>{day?.focus||"Rest"}{!isRest&&day?.exs?.length>0?` · ${day.exs.length} ex`:""}</div></div>{!isRest&&<Pill label={day?.tag||"HOME"} color={day?.color||C.accent}/>}</div>);})}</Card>
      <div style={{display:"flex",gap:8}}><Btn onClick={()=>setShowPlanEditor(true)} secondary style={{flex:1,padding:"12px",fontSize:13}}>✏️ Edit plan</Btn><Btn onClick={()=>setStep(2)} secondary style={{flex:"0 0 auto",padding:"12px",fontSize:13}}>← Back</Btn></div>
      <Btn onClick={()=>onDone({name,gender,age:ageNum,level,goals,equipment,injuries,createdAt:dk(),plan:buildFinalPlan()})} style={{width:"100%",background:"linear-gradient(135deg,#FF4500,#FF8C42)",fontSize:15}}>🔥 Let's forge it, {name.split(" ")[0]}!</Btn>
    </div>
  ];
  return(<div style={{minHeight:"100vh",background:C.bg,padding:"24px 20px 40px",maxWidth:430,margin:"0 auto",overflowY:"auto"}}><div style={{marginBottom:24}}><div className="sora" style={{fontSize:22,fontWeight:900,letterSpacing:-.5}}>FORGE<span style={{color:C.accent}}>.</span></div><div style={{display:"flex",gap:5,marginTop:10}}>{[0,1,2,3].map(i=><div key={i} style={{height:3,borderRadius:3,flex:i===step?2:1,background:i<=step?C.accent:C.border,transition:"all .4s"}}/>)}</div></div>{STEPS[step]}</div>);
}
    ...
    <div style={{padding:"12px 20px"}}>
      ...
      <div style={{background:C.card,border:`1.5px solid #1C2440`,borderRadius:14,padding:14,marginBottom:12}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
          <div><div style={{fontWeight:700,fontSize:14}}>💧 Water intake</div><div style={{fontSize:11,color:C.muted,marginTop:2}}>Target: 8 glasses</div></div>
          <div style={{fontSize:16,fontWeight:800,color:(log.water||0)>=8?"#34D399":"#3D9EFF"}}>{log.water||0} / 8</div>
        </div>
        <div style={{height:6,background:"#1C2440",borderRadius:6,overflow:"hidden",marginBottom:12}}><div style={{height:"100%",width:`${Math.min(100,((log.water||0)/8)*100)}%`,background:`linear-gradient(90deg,#3D9EFF,#34D399)`,borderRadius:6,transition:"width .4s cubic-bezier(.4,0,.2,1)"}}/></div>
        <div style={{display:"flex",gap:8}}>
          ...
          <div style={{flex:1,display:"flex",gap:4,alignItems:"center"}}>{Array.from({length:8},(_,i)=>(<div key={i} onClick={()=>setLog(currentDate,{...log,water:i+1})} style={{flex:1,height:28,borderRadius:6,background:i<(log.water||0)?"#3D9EFF":"#1C2440",cursor:"pointer",transition:"background .2s",border:`1px solid ${i<(log.water||0)?"#3D9EFF":"#2A3560"}`}}/>))}</div>
        ...
        <div style={{marginBottom:12}}>
          ...
          {[
            ...
            <div key={i} style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:14,padding:"14px",marginBottom:8,display:"flex",gap:12,alignItems:"flex-start"}}>
              ...
              <div><div style={{fontWeight:700,fontSize:13,color:C.text,marginBottom:4}}>{title}</div><div style={{fontSize:12,color:C.subtle,lineHeight:1.6}}>{tip}</div></div>
            </div>
          ))}
        </div>
      )}
          ...
          return(<div key={i} style={{background:done?C.card2+"AA":C.card,border:`1.5px solid ${done?C.border:isExp?dayPlan.color:C.border}`,borderRadius:16,marginBottom:8,overflow:"hidden",transition:"all .25s"}}>
            <div style={{display:"flex",alignItems:"flex-start",gap:12,padding:"12px 14px",cursor:"pointer"}} onClick={()=>setExpanded(e=>({...e,[i]:!isExp}))}>
              ...
              <div style={{display:"flex",gap:6,alignItems:"center",flexShrink:0}}>
                {/* FIX 1: use ex.n not name */}
                <button onClick={ev=>{ev.stopPropagation();window.open(`https://www.youtube.com/results?search_query=${encodeURIComponent("how to do "+ex.n+" exercise proper form")}`,"_blank");}} style={{width:26,height:26,background:"#FF0000CC",borderRadius:7,border:"none",cursor:"pointer",color:"#fff",fontSize:9,display:"flex",alignItems:"center",justifyContent:"center"}}>▶</button>
            ...
            {isExp&&(<div style={{padding:"0 14px 14px",borderTop:`1px solid ${C.border}`,background:"rgba(0,0,0,.25)"}}>
              <div style={{marginBottom:10}}><YTThumb name={ex.n} bp={ex.bp||info.bp} height={100}/></div>
      ...
      {/* Warmup + Stretch video links */}
      <div style={{display:"flex",gap:8,marginBottom:10}}>
        {[WARMUP_BY_DAY[dow],STRETCH_BY_DAY[dow]].map((item,i)=>(
          <div key={i} onClick={()=>window.open(`https://www.youtube.com/results?search_query=${encodeURIComponent(item.search)}`,"_blank")} style={{flex:1,background:C.card,border:`1.5px solid ${C.border}`,borderRadius:12,padding:"10px 12px",cursor:"pointer",display:"flex",gap:8,alignItems:"center"}}>
            <div style={{width:28,height:28,background:"#FF0000CC",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><span style={{color:"#fff",fontSize:11,marginLeft:2}}>▶</span></div>
            <div><div style={{fontSize:11,fontWeight:700,color:C.text,lineHeight:1.3}}>{i===0?"Today's warmup":"Today's stretch"}</div><div style={{fontSize:10,color:C.muted,marginTop:1}}>{item.label}</div></div>
          </div>
        ))}
      </div>

      {/* Recovery exercises — FIXED: no orphaned code below */}
    ...
    <div style={{padding:"0 20px"}}>
          ...
          {Object.entries(EX).filter(([,i])=>i.bp===selBP).map(([name,info])=>{const sessions=(data.strength||[]).filter(e=>e.exercise===name).sort((a,b)=>b.date<a.date?-1:1);const best=sessions.reduce((m,e)=>Math.max(m,parseFloat(e.weight)||0),0);const isSel=selEx===name;const target=(data.targets||{})[name];const tPct=target&&best>0?Math.min(100,Math.round(best/parseFloat(target)*100)):null;
            return(<div key={name} style={{background:isSel?C.card2:C.card,border:`1.5px solid ${isSel?BP[selBP]?.color:C.border}`,borderRadius:14,marginBottom:8,overflow:"hidden"}}>
              <div onClick={()=>setSelEx(isSel?null:name)} style={{padding:"12px 14px",cursor:"pointer",display:"flex",gap:12,alignItems:"center"}}>
                ...
                {/* FIX 2: use name (correct variable in this scope) */}
              ...
              {isSel&&(<div style={{padding:"0 14px 14px",borderTop:`1px solid ${C.border}`}}>
                <div style={{marginBottom:10}}><YTThumb name={selEx} bp={selBP} height={90}/></div>
      ...
      {tab==="log"&&<>
        ...
        {showForm&&<Card style={{marginBottom:14}}>
          ...
          {form.exercise&&<div style={{marginBottom:10}}><YTThumb name={form.exercise} bp={EX[form.exercise]?.bp} height={85}/></div>}
...
function ProgressPage({data,streak,earnedAchievements,onShare}){
  ...
  return(<div style={{padding:"16px 20px",paddingBottom:80}}>
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}><div className="sora" style={{fontSize:24,fontWeight:900}}>📊 Progress</div><button onClick={onShare} style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:10,padding:"8px 14px",color:C.subtle,cursor:"pointer",fontFamily:"DM Sans,sans-serif",fontWeight:600,fontSize:12}}>📤 Share</button></div>
    ...
    <Card><div style={{fontWeight:700,marginBottom:14,fontSize:14}}>🏆 Achievements</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>{ACHVS.map(a=>{const earned=earnedAchievements.includes(a.id);return(<div key={a.id} style={{background:earned?"#1A2440":"#0A0E1A",border:`1.5px solid ${earned?"#3A4570":C.border}`,borderRadius:12,padding:12,textAlign:"center",opacity:earned?1:0.4,transition:"all .3s"}}><div style={{fontSize:28,marginBottom:6,filter:earned?"none":"grayscale(100%)"}}>{a.icon}</div><div style={{fontSize:12,fontWeight:700,color:earned?C.text:C.muted,lineHeight:1.3}}>{a.title}</div><div style={{fontSize:10,color:C.muted,marginTop:3,lineHeight:1.4}}>{a.desc}</div>{earned&&<div style={{fontSize:9,color:C.accent,marginTop:4,fontWeight:700,letterSpacing:.5}}>UNLOCKED</div>}</div>);})}</div></Card>
  </div>);
}

function SettingsPage({data,setProfile,user,signOut,onShare}){
  const [showPlanEditor,setShowPlanEditor]=useState(false);const [showUpgrade,setShowUpgrade]=useState(false);
  const profile=data.profile||{};const level=profile.level||"Beginner";const preset=PRESET_PLANS[level];const nextLevel=LEVEL_ORDER[LEVEL_ORDER.indexOf(level)+1];
  const streak=useMemo(()=>calcStreak(data.logs||{}),[data.logs]);
  const totalDone=Object.values(data.logs||{}).reduce((s,l)=>s+Object.keys(l).filter(k=>k.startsWith("done_")&&l[k]).length,0);
  if(showPlanEditor)return(<PlanEditor profile={profile} preset={preset} injuries={profile.injuries||[]} title="Edit Your Plan" onSave={p=>{setProfile({...profile,plan:p});setShowPlanEditor(false);}} onClose={()=>setShowPlanEditor(false)}/>);
  return(<div style={{padding:"16px 20px",paddingBottom:80}}>
    ...
    <Card style={{marginBottom:14}}>
      <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:14}}>
        ...
        <div><div className="sora" style={{fontWeight:800,fontSize:17}}>{profile.name||user?.user_metadata?.full_name||"Athlete"}</div><div style={{fontSize:12,color:C.muted,marginTop:2}}>{profile.gender&&profile.age?`${profile.gender} · ${profile.age} yrs · `:""}Level: <span style={{color:C.accent,fontWeight:700}}>{level}</span></div>{profile.injuries&&profile.injuries.length>0&&!profile.injuries.includes("No injuries")&&<div style={{fontSize:11,color:"#F87171",marginTop:4}}>⚠️ Injuries: {profile.injuries.join(", ")}</div>}</div>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>{[{label:"Streak",val:`${streak}d`,icon:"🔥",color:C.accent},{label:"Done",val:totalDone,icon:"✅",color:"#34D399"},{label:"Sessions",val:(data.strength||[]).length,icon:"💪",color:"#E879F9"}].map(({label,val,icon,color})=><div key={label} style={{background:"#080B15",borderRadius:10,padding:"10px 8px",textAlign:"center"}}><div style={{fontSize:16}}>{icon}</div><div className="sora" style={{fontSize:16,fontWeight:800,color,marginTop:2}}>{val}</div><div style={{fontSize:10,color:C.muted}}>{label}</div></div>)}</div>
    </Card>
    ...
    <Card style={{marginBottom:10}}>
      ...
      <div style={{display:"flex",gap:8}}><Btn onClick={()=>setShowPlanEditor(true)} style={{flex:1,padding:"11px",fontSize:13,background:"#6366F1"}}>✏️ Edit plan</Btn>{nextLevel&&<Btn onClick={()=>setShowUpgrade(true)} style={{flex:1,padding:"11px",fontSize:13,background:"linear-gradient(135deg,#FF4500,#FF8C42)"}}>⬆️ Upgrade to {nextLevel}</Btn>}</div>
    </Card>
    ...
    <Card style={{marginBottom:14}}>{[0,1,2,3,4,5,6].map((d,i)=>{const day=(profile.plan||{})[d];const isRest=day?.type==="rest";return(<div key={d} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 0",borderBottom:i<6?`1px solid ${C.border}`:"none"}}><div style={{width:32,height:32,borderRadius:9,background:isRest?"#1C2440":day?.color+"22",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,flexShrink:0}}>{day?.emoji||"😴"}</div><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600,color:isRest?C.muted:C.text}}>{FULL_DAYS[d]}</div><div style={{fontSize:11,color:C.muted}}>{day?.focus||"Rest"}</div></div>{!isRest&&day?.exs?.length>0&&<span style={{fontSize:11,color:C.muted}}>{day.exs.length} ex</span>}</div>);})}</Card>
    ...
    <Card>
      ...
      <button onClick={async()=>{try{if(navigator.share)await navigator.share({title:"FORGE — Fitness Tracker",text:"Track your workouts, strength & body on FORGE 🔥",url:"https://forgebetteryou.netlify.app"});}catch{}}} style={{width:"100%",padding:"13px",borderRadius:12,background:`${C.accent}20`,color:C.accent,border:`1.5px solid ${C.accent}40`,cursor:"pointer",fontWeight:700,fontSize:14,fontFamily:"DM Sans,sans-serif",marginBottom:10}}>🔗 Invite a friend to FORGE</button>
...
export default function App(){
  ...
  useEffect(()=>{if(!data.profile)return;const newOnes=earnedAchievements.filter(id=>!prevAchievements.current.includes(id));if(newOnes.length>0){const a=ACHVS.find(x=>x.id===newOnes[0]);if(a)setNewAchievement(a);saveAchievements(earnedAchievements);}prevAchievements.current=earnedAchievements;},[earnedAchievements]);
  ...
  return(<>
    ...
    <div style={{display:"flex",flexDirection:"column",height:"100vh",background:C.bg,maxWidth:430,margin:"0 auto"}}>
      <div style={{background:C.bg,borderBottom:`1px solid ${C.border}`,padding:"12px 20px 10px",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div><div className="sora" style={{fontSize:15,fontWeight:900,letterSpacing:.5}}>FORGE<span style={{color:C.accent}}>.</span></div><div style={{fontSize:12,color:C.muted}}>Hey, {data.profile?.name?.split(" ")[0]||"there"} 👋</div></div>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <div style={{textAlign:"right"}}><div style={{fontSize:10,color:C.muted,marginBottom:3}}>Today</div><div style={{display:"flex",alignItems:"center",gap:8}}><div style={{width:56,height:4,background:C.border,borderRadius:4,overflow:"hidden"}}><div style={{height:"100%",width:`${todayPct}%`,background:C.accent,borderRadius:4,transition:"width .5s"}}/></div><div className="sora" style={{fontSize:14,fontWeight:800,color:todayPct>=100?"#34D399":todayPct>50?"#FBBF24":C.accent}}>{todayPct}%</div></div></div>
      ...
      <div style={{flex:1,overflowY:"auto",overflowX:"hidden"}}>
        ...
        {page===4&&<SettingsPage data={data} setProfile={setProfile} user={user} signOut={signOut} onShare={()=>setShowShare(true)}/>}
      </div>
